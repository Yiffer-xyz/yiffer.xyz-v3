...
export default function ArtistPage() {
  ...
  useEffect(() => {
    const comicName = artist?.name ?? queriedArtistName;
    if (!comicName) {
      document.title = 'Not found | Yiffer.xyz';
    } else {
      document.title = `${comicName} (Artist) | Yiffer.xyz`;
    }
  }, [artist?.name, queriedArtistName]);
