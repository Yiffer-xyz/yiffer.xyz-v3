...
export default function JoinUsApplyPage() {
  ...
  const showHasExistingApplication = hasExistingApplication && !fetcher.success;
  ...
  return (
    <div className="container mx-auto pb-8">
      ...
      {showHasExistingApplication && (
        <InfoBox
          variant="info"
          showIcon
          text="We have received your application. If we are in need of more mods, we might be in touch via Telegram."
          className="my-4"
        />
      )}
      ...
      {!showHasExistingApplication && !fetcher.success && (
