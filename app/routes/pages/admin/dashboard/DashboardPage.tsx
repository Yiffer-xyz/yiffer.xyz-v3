...
import type { ProcessTagSuggestionBody } from '~/routes/api/admin/process-tag-suggestion';
import { useMemo, useState } from 'react';
import type { AssignActionBody } from '~/routes/api/admin/assign-action';
import type { UnAssignActionBody } from '~/routes/api/admin/unassign-action';
import type { ProcessComicProblemBody } from '~/routes/api/admin/process-comic-problem';
import type { ProcessComicSuggestionBody } from '~/routes/api/admin/process-comic-suggestion';
import type { ComicSuggestionVerdict, TagSuggestionItem } from '~/types/types';
import type {
  DashboardAction,
  DashboardActionType,
} from '~/routes/api/admin/dashboard-data';
...
import type { GlobalAdminContext } from '~/routes/pages/admin/AdminPage';
import { ComicCommentReport } from './ComicCommentReport';
import type { ProcessComicCommentReportBody } from '~/routes/api/admin/process-comic-comment-report';
