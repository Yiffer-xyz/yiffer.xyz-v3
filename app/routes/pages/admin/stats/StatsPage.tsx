...
import { formatBigNumber } from '~/utils/string-utils';
...
export default function Stats() {
  ...
  return (
    <>
      ...
      <h2>General</h2>
      <p>
        <b>{formatBigNumber(stats.totalUsers)}</b> users
      </p>
      <p>
        <b>{formatBigNumber(stats.totalComics)}</b> comics
      </p>
      <p>
        <b>{formatBigNumber(stats.totalPages)}</b> pages
      </p>
      <p>
        <b>{formatBigNumber(stats.totalArtists)}</b> artists
      </p>
      <p>
        <b>{formatBigNumber(stats.comicComments)}</b> comic comments
      </p>
